      ...
      <div style={{ display: "flex"}}>
        <Grid container style={{ backgroundColor: "#0f2540" }} >
          <Grid item xs={12} sm={4}>
            <div className="section22" style={{ height: screenHeight / 1.7, backgroundColor: "#0f2540" }} >
              <div className="section1" style={{ height: screenHeight / 2, textAlign: "center", paddingTop: "7%" }}>
                ...
                <p style={{ color: "#dcdadaf5" }}> <MailIcon style={{ color: "#ffffff" }} /> honeyshery@yahoo.com</p>
          ...
          <Grid  item xs={12} sm={4}  style={{ backgroundColor: "#0f2540" }} >
              <div  className="section22" style={{ height: screenHeight / 1.7, backgroundColor: "#0f2540" }} >
                <div className="section2" style={{ height: screenHeight / 2, textAlign: "center", paddingTop: "5%" }}>
            ...
            <Grid item sm={4} xs={12}>
              <div style={{ height: screenHeight / 1.7, backgroundColor: "#0f2540" }} >
                <div style={{ height: screenHeight / 2, paddingTop: "6%",textAlign:"center" }}>
                  <img href="/about" src={dr} alt="Title" style={{ height: "100%", width: "90%" }} />
                </div>
              </div>
            </Grid>
          </Grid>
